...
function createCard(transport) {
    ...
    <h3 style="font-size:1.25rem;font-weight:600;color:#000004;margin-bottom:8px;"> ${transport.nameInput}</h3>
    <h2 style="font-size:1rem;font-weight:500;color:#000004;margin-botton:10px;">${transport.}
